...
class PersonAdapter(var personList:ArrayList<Person>): RecyclerView.Adapter<PersonAdapter.MyViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int) = MyViewHolder(LayoutInflater.from(parent.context).inflate(R.layout.person_row,parent,false))

    override fun onBindViewHolder(holder: MyViewHolder, position: Int) = holder.bindItems(personList.get(position))
